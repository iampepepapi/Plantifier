...
const DHTMoistureViewer = () => {
    ...
    const handleRefresh = async () => {
        try {
            const response = await fetch(
                "http://localhost:3001/refresh-connection"
            ); // Use full URL
    ...
    return (
        <div className="">
            <Card className="flex flex-col w-96 md:w-[780px] p-0 md:p-0 border-secondary">
                <CardHeader>
...
export default DHTMoistureViewer;
